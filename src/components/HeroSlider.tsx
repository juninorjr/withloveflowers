...
import slider3 from "@/assets/72cc1c4a-0574-4436-bc3c-c04f9b6edfb1.png";
...
const HeroSlider = () => {
  ...
  return (
    <section className="relative w-full mt-20 overflow-hidden bg-muted aspect-[4/5] sm:aspect-[16/9] md:aspect-[21/9] max-h-[85vh]">
      {slides.map((img, i) => (
        <div
          key={i}
